...
<head>
    ...
    <title><?php echo (L("title_choiceitem")); ?></title>
...
<body style="height:auto !important; min-height:600px; _height:700px;">
        ...
        <div class="reg-left">
            <form id="registerform" method="post">
                <?php if(is_array($array)): $i = 0; $__LIST__ = $array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($mod) == "0"): ?><div class="reg-field">
                        <input class="radio-text" type="radio" name="radiobutton" value=<?php echo ($vo["classId"]); ?> onclick="clickRadio('<?php echo ($vo["classId"]); ?>')">
                        <label><?php echo ($vo["class"]); ?></label><?php endif; ?>     
                    <?php if(($mod) == "1"): ?><input class="radio-text" type="radio" name="radiobutton" value=<?php echo ($vo["classId"]); ?> onclick="clickRadio('<?php echo ($vo["classId"]); ?>')">
                        <label><?php echo ($vo["class"]); ?></label>  
    ...
    <script language="JavaScript" type="text/javascript" charset="utf-8">
        function clickRadio(classid)
        {
            window.location.href="__APP__/Choicedetail/index/classid/"+classid;
        }
        function loginfo(){
