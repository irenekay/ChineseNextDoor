...
class DbMysqli extends Db{
    ...
    public function free() {
        ...
        is_object($this->queryID)&&$this->queryID->free_result();
        $this->queryID = null;
    }
    ...
    public function query($str) {
        ...
        // 对存储过程改进
        while ($this->_linkID->more_results() && ($res = $this->_linkID->next_result()) != null) {
            // 临时修正bug，$res可能为boolean值 by ifindever@gmail.com
            is_object($res)&&$res->free_result();
        }
